...
// node_modules/easy.auth98/src/session.js
...
// node_modules/easy.auth98/src/index.js
var config = {
...
var TOKEN_COOKIE = "easyauth_access_token";
var REFRESH_TOKEN_COOKIE = "easyauth_refresh_token";
...
function setTokens(accessToken, refreshToken2) {
  ...
  if (refreshToken2) {
    setCookie(REFRESH_TOKEN_COOKIE, refreshToken2, {
      maxAge: 7 * 24 * 60 * 60,
      secure: window.location.protocol === "https:",
      sameSite: "lax"
    });
...
async function refreshAccessToken() {
  try {
    ...
    const refreshClient = axios_default.create({
      baseURL: config.baseURL,
...
async function signIn(email, password, applicationUrl = "") {
  var _a, _b, _c, _d;
  try {
    ...
    return {
      success: false,
      error: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) || "NETWORK_ERROR",
      message: ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || "Login failed"
    };
  }
}
async function signUp(email, password, username, applicationUrl = "", emailConfig = null) {
  ...
  try {
    ...
    return {
      success: false,
      error: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) || "NETWORK_ERROR",
      message: ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || "Registration failed",
      details: (_f = (_e = error.response) == null ? void 0 : _e.data) == null ? void 0 : _f.details
      // Include validation details
    };
  }
}
async function signOut() {
  ...
  try {
    ...
    return {
      success: false,
      error: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) || "LOGOUT_ERROR",
      message: ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || "Logout failed"
    };
  }
}
...
async function verifyToken() {
  ...
  try {
    ...
    throw new Error(((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "Token verification failed");
  }
}
...
async function resendVerificationEmail(email, applicationUrl = "", emailConfig = null) {
  var _a, _b, _c, _d;
  try {
    ...
    return {
      success: false,
      error: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) || "NETWORK_ERROR",
      message: ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || "Failed to resend verification email"
    };
  }
}
async function forgotPassword(email, applicationUrl = "") {
  var _a, _b, _c, _d;
  try {
    ...
    return {
      success: false,
      error: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) || "NETWORK_ERROR",
      message: ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || "Failed to process forgot password request"
    };
  }
}
function debugTokens() {
  const accessToken = getAccessToken();
  const refreshToken2 = getRefreshToken();
  const isAuth = !!(accessToken || refreshToken2);
  console.log("Token Debug Info:");
  console.log("Access Token:", accessToken ? `${accessToken.substring(0, 20)}...` : "Not found");
  console.log("Refresh Token:", refreshToken2 ? `${refreshToken2.substring(0, 20)}...` : "Not found");
...
// node_modules/easy.auth98/src/hooks.js
...
//# sourceMappingURL=easy__auth98.js.map
